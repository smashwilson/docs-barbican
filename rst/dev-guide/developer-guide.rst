...
using the REST application programming interface (API) for the Rackspace Cloud Keep
service.

To use the information provided here, you should have a general understanding of the
Rackspace Cloud Keep service and have a `Rackspace Cloud account`_ with access to the Cloud Keep service. You
